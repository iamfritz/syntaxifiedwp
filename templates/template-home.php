            ...
            <div class="row align-center">
              <div class="col-md-12 col-lg-5">
                <div class="hero-content">
                  ...
                  <div class="form">
                  <form id="chimp-form" class="subscribe-form" action="<?php echo get_template_directory_uri();?>/assets/php/subscribe.php" method="post" accept-charset="UTF-8" enctype="application/x-www-form-urlencoded" autocomplete="off" novalidate>
